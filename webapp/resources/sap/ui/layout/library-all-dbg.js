...
if ( !jQuery.sap.isDeclared('sap.ui.layout.BlockLayout.designtime') ) {
/*!
...
jQuery.sap.declare('sap.ui.layout.BlockLayout.designtime'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("sap/ui/layout/BlockLayout.designtime",[],
	function () {
		"use strict";
...
}; // end of sap/ui/layout/BlockLayout.designtime.js
if ( !jQuery.sap.isDeclared('sap.ui.layout.BlockLayoutCell.designtime') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2017 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
// Provides the Design Time Metadata for the sap.ui.layout.BlockLayout control
jQuery.sap.declare('sap.ui.layout.BlockLayoutCell.designtime'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("sap/ui/layout/BlockLayoutCell.designtime",[],
	function () {
		"use strict";
...
}; // end of sap/ui/layout/BlockLayoutCell.designtime.js
if ( !jQuery.sap.isDeclared('sap.ui.layout.BlockLayoutRow.designtime') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2017 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('sap.ui.layout.BlockLayoutRow.designtime'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("sap/ui/layout/BlockLayoutRow.designtime",[],
	function () {
		"use strict";
...
}; // end of sap/ui/layout/BlockLayoutRow.designtime.js
if ( !jQuery.sap.isDeclared('sap.ui.layout.FixFlex.designtime') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2017 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('sap.ui.layout.FixFlex.designtime'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("sap/ui/layout/FixFlex.designtime",[],
	function () {
		"use strict";
...
}; // end of sap/ui/layout/FixFlex.designtime.js
...
sap.ui.define("sap/ui/layout/HorizontalLayoutRenderer",[],
	function() {
	"use strict";
...
sap.ui.define("sap/ui/layout/ResponsiveFlowLayoutRenderer",[],
	function() {
	"use strict";
...
sap.ui.define("sap/ui/layout/ResponsiveSplitterUtilities",[], function() {
	"use strict";
...
if ( !jQuery.sap.isDeclared('sap.ui.layout.Splitter.designtime') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2017 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('sap.ui.layout.Splitter.designtime'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("sap/ui/layout/Splitter.designtime",[],
    function () {
        "use strict";
...
}; // end of sap/ui/layout/Splitter.designtime.js
...
sap.ui.define("sap/ui/layout/SplitterRenderer",["sap/ui/core/library"],
...
sap.ui.define("sap/ui/layout/VerticalLayoutRenderer",[],
	function() {
	"use strict";
...
if ( !jQuery.sap.isDeclared('sap.ui.layout.changeHandler.AddFormField') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2017 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('sap.ui.layout.changeHandler.AddFormField'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('sap.ui.fl.Utils'); // unlisted dependency retained
jQuery.sap.require('sap.ui.fl.changeHandler.ChangeHandlerMediator'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/changeHandler/AddFormField",[
		"sap/ui/fl/Utils",
	...
	/* bExport= */true);
}; // end of sap/ui/layout/changeHandler/AddFormField.js
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.fl.changeHandler.JsControlTreeModifier'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/changeHandler/MoveSimpleForm",["jquery.sap.global", "sap/ui/fl/changeHandler/JsControlTreeModifier"],
...
if ( !jQuery.sap.isDeclared('sap.ui.layout.flexibility.BlockLayoutCell.flexibility') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2017 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('sap.ui.layout.flexibility.BlockLayoutCell.flexibility'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('sap.ui.fl.changeHandler.BaseRename'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/flexibility/BlockLayoutCell.flexibility",[
...
}; // end of sap/ui/layout/flexibility/BlockLayoutCell.flexibility.js
...
jQuery.sap.require('sap.ui.fl.changeHandler.ChangeHandlerMediator'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/FormContainer.designtime",['sap/ui/fl/changeHandler/ChangeHandlerMediator'],
...
sap.ui.define("sap/ui/layout/form/SimpleFormRenderer",[],
	function() {
	"use strict";
...
jQuery.sap.require('sap.ui.core.library'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/library",[
...
sap.ui.define("sap/ui/layout/AlignedFlowLayout",['jquery.sap.global', 'sap/ui/core/Control', './library', 'sap/ui/core/ResizeHandler'],
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/BlockLayout",['sap/ui/core/Control', './library', 'jquery.sap.global', 'sap/ui/core/ResizeHandler'],
...
sap.ui.define("sap/ui/layout/BlockLayoutCellData",['sap/ui/core/LayoutData', './library'],
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.library'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/BlockLayoutCellRenderer",['jquery.sap.global', './library', 'sap/ui/core/library'],
...
sap.ui.define("sap/ui/layout/BlockLayoutRowRenderer",['./library'],
	function (library) {
		"use strict";
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/DynamicSideContent",['jquery.sap.global', 'sap/ui/core/Control', 'sap/ui/core/ResizeHandler', 'sap/ui/layout/library'],
...
sap.ui.define("sap/ui/layout/DynamicSideContentRenderer",["sap/ui/layout/library", "sap/ui/Device"],
...
jQuery.sap.require('sap.ui.Device'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/Grid",['jquery.sap.global', 'sap/ui/core/Control', './library', 'sap/ui/Device', 'sap/ui/core/ResizeHandler'],
...
jQuery.sap.require('sap.ui.Device'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/GridRenderer",["sap/ui/Device", "sap/ui/layout/library"],
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/HorizontalLayout",['sap/ui/core/Control', './library'],
	function(Control, library) {
	"use strict";
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/ResponsiveSplitterPage",["./library", "sap/ui/core/Control"],
...
sap.ui.define("sap/ui/layout/SplitPane",['./library', 'sap/ui/core/Element'],
...
jQuery.sap.require('sap.ui.core.library'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/Splitter",['jquery.sap.global', 'sap/ui/core/Control', './library', 'sap/ui/core/library', 'sap/ui/core/ResizeHandler'],
...
jQuery.sap.require('sap.ui.core.LayoutData'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/SplitterLayoutData",['sap/ui/core/LayoutData', './library'],
	function(LayoutData, library) {
	"use strict";
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.EnabledPropagator'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/VerticalLayout",['sap/ui/core/Control', 'sap/ui/core/EnabledPropagator', './library'],
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/Form",['sap/ui/core/Control', 'sap/ui/layout/library'],
	function(Control, library) {
	"use strict";
...
sap.ui.define("sap/ui/layout/form/FormContainer",['jquery.sap.global', 'sap/ui/core/Element', 'sap/ui/core/theming/Parameters', 'sap/ui/layout/library'],
...
sap.ui.define("sap/ui/layout/form/FormElement",['jquery.sap.global', 'sap/ui/core/Element', 'sap/ui/base/ManagedObjectObserver', 'sap/ui/layout/library'],
...
jQuery.sap.require('sap.ui.core.library'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/FormLayoutRenderer",["sap/ui/layout/library", "sap/ui/core/library"],
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/FormRenderer",['jquery.sap.global', 'sap/ui/layout/library'],
...
jQuery.sap.require('sap.ui.core.LayoutData'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/GridContainerData",['sap/ui/core/LayoutData', 'sap/ui/layout/library'],
 function(LayoutData, library) {
	"use strict";
...
jQuery.sap.require('sap.ui.core.LayoutData'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/GridElementData",['sap/ui/core/LayoutData', 'sap/ui/layout/library'],
	function(LayoutData, library) {
	"use strict";
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/ResponsiveGridLayout",['jquery.sap.global', 'sap/ui/layout/Grid', 'sap/ui/layout/GridData', './FormLayout', 'sap/ui/layout/library', 'sap/ui/core/Control', 'sap/ui/core/ResizeHandler'],
...
jQuery.sap.require('sap.ui.core.Renderer'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/ResponsiveGridLayoutRenderer",['sap/ui/core/Renderer', './FormLayoutRenderer'],
...
jQuery.sap.require('sap.ui.core.Renderer'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/ResponsiveLayoutRenderer",['sap/ui/core/Renderer', './FormLayoutRenderer'],
	function(Renderer, FormLayoutRenderer) {
	"use strict";
...
jQuery.sap.require('sap.ui.base.ManagedObjectObserver'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/SimpleForm",['jquery.sap.global', 'sap/ui/core/Control',
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/AssociativeSplitter",['./Splitter', './SplitterRenderer', 'jquery.sap.global'],
...
jQuery.sap.require('sap.ui.core.Element'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.library'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/PaneContainer",['./library', 'sap/ui/core/Element', './AssociativeSplitter', 'sap/ui/core/library'],
...
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
jQuery.sap.require('sap.ui.Device'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/ResponsiveFlowLayout",['jquery.sap.global', 'sap/ui/core/Control', './ResponsiveFlowLayoutData', './library', 'sap/ui/core/ResizeHandler', 'sap/ui/Device'],
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
sap.ui.define("sap/ui/layout/form/ResponsiveLayout",['jquery.sap.global', 'sap/ui/layout/ResponsiveFlowLayout', 'sap/ui/layout/ResponsiveFlowLayoutData', './FormLayout', 'sap/ui/layout/library', 'sap/ui/core/Control'],
